...
원래는 프로그래밍 대회를 준비하는 사람들에게 매우 적합한 사이트였는데, 요즘에는 변신을 조금 하고 있답니다. 먼저, [슬랙](https://www.acmicpc.net/slack)과 [게시판](https://www.acmicpc.net/board)을 통해서 커뮤니티로 변신을 성공했어요. 그리고, 프로그램이 관련 스터디를 운영하는 모임에도 도움이 되기 위해 [그룹](https://www.acmicpc.net/group)도 오픈했지요. 
